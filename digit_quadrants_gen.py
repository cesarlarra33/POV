...
IMG_SIZE = 120        # <--- mets ici 120 / 140 / 180 / etc.
SEUIL = 128
PADDING_RATIO = 0.15
LED_COUNT = 16
ZOOM = 0.95
...
with open(digits_c_path, "w") as f:
    ...
    for digit in range(10):
        ...
        # -------------------------------------------------------------------
        # RÉORDONNANCEMENT DES QUARTS COMME DANS TON ANCIEN SCRIPT
        #
        # ordre source (dans buffers_polar) :
        #   Qsrc0 : [0 .. quart_size-1]         ~ 0..90°
        #   Qsrc1 : [quart_size .. 2*quart_size-1]
        #   Qsrc2 : [2*quart_size .. 3*quart_size-1]
        #   Qsrc3 : [3*quart_size .. 4*quart_size-1]
        #
        # ordre de sortie que tu avais :
        #   Q1 = ancien Q2
        #   Q2 = ancien Q3
        #   Q3 = ancien Q4
        #   Q4 = ancien Q1
        ...
        for out_idx, src_idx in enumerate(src_quarts):
            ...
            for i, (_, mask) in enumerate(buffers_polar[start:end]):
                # index global dans la séquence continue 0..N-1
